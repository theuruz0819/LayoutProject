...
public class FullScannerFragment extends Fragment implements MessageDialogFragment.MessageDialogListener,
    ...
    // interface to main for changing to another fragemtnt
    public interface FragmentTransitionListener {
        public void transition(Fragment fragment, String tag);
    }

    private FragmentTransitionListener mTrigger;
    ...
    public void setTransitionTrigger(FragmentTransitionListener trigger){
    ...
    public void onDialogPositiveClick(DialogFragment dialog) {
        ...
        fragment.setTargetUrl(resultUrl);
        mTrigger.transition(fragment,"parsorPage");
    }
